...
class SettingScreen: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(UINib(nibName: "SettingAuthCell", bundle: nil), forCellReuseIdentifier: "SettingAuthCell")
        self.tableView.register(UINib(nibName: "PermissionCell", bundle: nil), forCellReuseIdentifier: "PermissionCell")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cell = tableView.dequeueReusableCell(withIdentifier: "PermissionCell", for: indexPath) as! PermissionCell 
                ...
                return cell
        case 1:
            let cell = tableView.dequeueReusableCell(withIdentifier: "SettingAuthCell", for: indexPath) as! SettingAuthCell
