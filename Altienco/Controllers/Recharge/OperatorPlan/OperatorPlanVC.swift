...
class OperatorPlanVC: UIViewController {
    ...
    func initiateModel() {
        viewModel?.getOperatorPlans(OperatorID: self.OperatorID, transactionTypeId: TransactionTypeId.PhoneRecharge.rawValue, langCode: "en") { (operatorList, status, message) in
